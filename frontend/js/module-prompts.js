...
const MODULES = {
  ...
  '14-WORK':{ name:'Simetrik Second Brain · 3 menús · 16 paneles', files:'work.html + css/work.css + js/work.js + js/nb-shared.js + data/simetrik-kb.json + pages/simetrik-kb.html', keys:'work_cases · work_errors · work_learnings · work_kb · work_nb_meta · work_nb_data · work_eco_workflow · work_eco_course · work_eco_dict · work_kb_atts · work_moif_meetings · work_eco_dict_seed_v + work_eco_dict_brain_v (local-only)', notes:'CEREBRO: data/simetrik-kb.json es la UNICA fuente de verdad Simetrik (~440 entradas con evidencia); Diccionario/Guia/Simulador se alimentan de el. Ingesta: cuaderno "Simetrik · Ingesta" + PROMPT_14-WORK_SIMETRIK-INGEST.md con GATE de validacion. Nav: 3 desplegables (Aprender · Trabajo&Conocimiento · Registro). Cyan #06b6d4 = identidad Simetrik · MOIF=reuniones Ficohsa.' },
